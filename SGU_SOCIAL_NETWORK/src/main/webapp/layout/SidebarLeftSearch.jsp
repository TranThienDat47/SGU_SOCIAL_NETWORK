	...
	<div class="sidebar_left-wrapper">
		<div class="sidebar_left-top">
			...
			<ul class="sidebar_left-menu">
				<a
					href="/SGU_SOCIAL_NETWORK/Search.jsp?page=all&value=<%=request.getParameter("value")%>"><li
					class='sidebar_left-menu-item <%=request.getParameter("page").equals("all") ? "sidebar_left-menu-item_active" : ""%>'><i>
						...
						<div>Tất cả</div></li></a>
				<a
					href="/SGU_SOCIAL_NETWORK/Search.jsp?page=post&value=<%=request.getParameter("value")%>"><li
				...
				<a
					href="/SGU_SOCIAL_NETWORK/Search.jsp?page=user&value=<%=request.getParameter("value")%>">
					<li
