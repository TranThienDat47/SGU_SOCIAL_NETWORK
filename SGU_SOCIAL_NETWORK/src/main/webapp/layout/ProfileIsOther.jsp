	...
	<div class="profile_user">
		...
		<div class="profile_user-body_profile">
			...
			<div class="profile_user-profile_public">
				...
				<a href="/SGU_SOCIAL_NETWORK/Message.jsp">
					<button type="button" class="global_post-status_profile">
