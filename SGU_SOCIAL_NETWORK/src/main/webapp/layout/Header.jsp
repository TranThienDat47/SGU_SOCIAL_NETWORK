...
<div id="global_header">
	...
	<div class="header_right">
		<div class="header_list-action">
			...
			<a href="/SGU_SOCIAL_NETWORK/Message.jsp" class="header_item-action">
